...
router.post('/register', [], async (req, res, next) => {
    try {
        const { name, firstName, lastName, phone, email, password, gender,
        ...
        console.log(name, firstName, lastName, phone, email, password, gender,
            dob, avatar, point, createdAt, updatedAt, address, longitude, latitude,
            status, role, isLogin, isActive, verificationCode,
            isVerifiedPhone, isVerifiedEmail)
        const user = await userController.register(name, firstName, lastName, phone, email, password, gender,
            dob, avatar, point, createdAt, updatedAt, address, longitude, latitude,
            status, role, isLogin, isActive, verificationCode,
             isVerifiedPhone, isVerifiedEmail);
        console.log(user)
